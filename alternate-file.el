...
;; files.  Instead it relies on user-supplied rules in alternate-file-settings
;; variable - user should specify implementation directory, test directory and
;; suffix of test files for each major mode manually.  As of now test prefixes
;; are not supported because I don't use such languages but feel free to open
;; a new issue in case you need them.
;;
